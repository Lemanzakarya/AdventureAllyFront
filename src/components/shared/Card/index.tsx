...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <Link to="#"
      className="flex mx-auto min-w-1/2 flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
    >
      <img
        className="rounded-t-lg w-full min-h-full md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
